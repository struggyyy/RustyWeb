    ...
    <div className="min-h-screen flex items-center justify-center p-4 font-sans">
      <div className="max-w-md w-full bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-10 border border-neutral-100">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-extrabold text-text-dark mb-3">Welcome Back</h1>
          <p className="text-text-primary">Sign in to manage your reports and profile.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center text-text-primary font-medium cursor-pointer">
              <input type="checkbox" className="mr-3 w-4 h-4 rounded border-neutral-200 text-brand-primary focus:ring-brand-primary" />
              Remember me
            </label>
            <a href="#" className="text-brand-primary hover:underline font-bold">Forgot password?</a>
          </div>
